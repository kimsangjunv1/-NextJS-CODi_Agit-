...
const Header = () => {
    ...
    return (
        <Fragment>
                                    ...
                                    >
                                        {[ "전체", "개발", "디자인", "3D" ].map((e, i) =>
                                            <motion.section
                                                ...
                                                className={`flex gap-[1.6rem] ${ categoryFilter === i ? "text-[#dd4f1b]" : "" }`}
                                            >
                                                <UI.Button
                                                    key={i}
            ...
            <button
                className="hamburger w-[1.6rem] h-[1.6rem] px-[4.0rem] py-[2.0rem] fixed top-[3.6rem] right-0 transform translate-x-[0] translate-y-[-50%] text-[2.4rem] z-[10000]"
