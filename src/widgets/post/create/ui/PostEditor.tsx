...
import { useGetPostDetailQuery, usePatchPostQuery, useSetPostQuery } from '@/entities/post/api/post.query';
...
import { DUMMY_POST_RESPONSE_NEW } from '@/shared/constants/lists/configDummyResponse';
